...
originally contributed by Kevin Carson

Modified by Felix LeClair for compiler testing as well as modifications prior to resubmission
*/
...
/*        printf
  ...
  */  } /* for(depth = minDepth...) */
	...
	double finaltime = (double)time/CLOCKS_PER_SEC;
